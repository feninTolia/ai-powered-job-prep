  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full max-w-[2000px] mx-auto flex-grow h-screen-header">
      <div className="container flex gap-4 mt-4 items-center justify-between">
        ...
        <Controls
          status={status}
          isLoading={isGenerating || isGeneratingFeedback}
          disableAnswerButton={
            answer?.trim() === '' || answer == null || questionId == null
          }
      ...
      <ResizablePanel id="answer" defaultSize={50} minSize={5}>
        <ScrollArea className="h-full min-w-48 *:h-full">
          <Textarea
            ...
            className="w-full h-full resize-none border-none rounded-none focus-visible:ring focus-visible:ring-inset text-base!"
          />
        </ScrollArea>
      </ResizablePanel>
    </ResizablePanelGroup>
